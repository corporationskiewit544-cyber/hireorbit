...
export function Navbar() {
  ...
  return (
    <motion.nav
      ...
      className={cn(
        'fixed top-0 left-0 right-0 z-50 transition-all duration-300 ease-in-out border-b h-24',
        scrolled ? 'bg-slate-900/40 backdrop-blur-md border-slate-700/50 shadow-lg' : 'bg-transparent border-transparent'
      )}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
        <div className="flex items-center justify-between h-full">
          ...
          <Link to="/" className="flex-shrink-0 cursor-pointer">
            <img src="/logo.png" alt="HireOrbit" className="h-20 w-auto object-contain -my-2" />
          </Link>
